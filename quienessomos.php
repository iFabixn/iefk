...
?>
    ...
    <main class="main-content">
      ...
      <div class="qs-row">
        <div class="qs-img-col">
          <img src="assets/img/niñoyniña.png" alt="Imagen quienes somos">
        </div>
        <div class="qs-info-col">
          <div class="qs-subtitle">"Educamos lo mejor <br> de ti, tu hijo..."</div>
          <div class="qs-cenefa">
            <img src="assets/img/cenefarombosmobile.png" alt="Cenefa divisoria" class="cenefa-img-divider3">
          </div>
          <div class="qs-lorem">
            <p>Somos una comunidad educativa comprometida con formar personas íntegras, libres y conscientes, capaces de transformar su entorno con valores, pensamiento crítico y amor por el conocimiento. Nuestro modelo educativo parte de la convicción de que la infancia es la etapa más valiosa para sembrar confianza, creatividad y seguridad personal. Por ello, nuestros docentes trabajan con pasión, profesionalismo y empatía, guiando a cada niña y niño en el descubrimiento de su potencial. Aquí, cada historia de aprendizaje comienza con un vínculo auténtico entre escuela, familia y comunidad.</p>
          </div>
        </div>
      </div>
    </main>
...
<section class="main-content">
  <div class="qs-mvv-col">
    <!-- Imagen superior -->
    <div class="qs-mvv-img">
      <img src="assets/img/logo frida kahlo horizontal.png" alt="Misión, Visión y Valores">
    </div>
    <!-- Secciones inferiores en row -->
    <div class="qs-mvv-row">
      <!-- Misión -->
      <div class="qs-mvv-item">
        <h2 class="qs-mvv-title">Misión</h2>
        <div class="qs-mvv-cenefa">
          <img src="assets/img/cenefarombosmobile.png" alt="Cenefa divisoria" class="cenefa-img-divider4">
        </div>
        <div class="qs-mvv-text">
          <p>Otorgar un servicio educativo de calidad, promoviendo pautas de convivencia familiar y comunitaria fundadas en el respeto, protección y ejercicio de los derechos humanos.</p>
        </div>
      </div>
      <!-- Visión -->
      <div class="qs-mvv-item">
        <h2 class="qs-mvv-title">Visión</h2>
        <div class="qs-mvv-cenefa">
          <img src="assets/img/cenefarombosmobile.png" alt="Cenefa divisoria" class="cenefa-img-divider4">
        </div>
        <div class="qs-mvv-text">
          <p>Ser parte de una solución educativa, diseñando, implementando, monitoreando, evaluando y dando resultado de un desarrollo integral y general del alumno.</p>
        </div>
      </div>
      <!-- Valores -->
      <div class="qs-mvv-item">
        <h2 class="qs-mvv-title">Valores</h2>
        <div class="qs-mvv-cenefa">
          <img src="assets/img/cenefarombosmobile.png" alt="Cenefa divisoria" class="cenefa-img-divider4">
        </div>
        <div class="qs-mvv-text">
          <p>Responsabilidad, amor, compromiso, perseverancia, tolerancia, gratitud, puntualidad, amistad y alegría.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="qs-servicios-list">
      <div class="qs-servicios-column">
        <div class="qs-servicio-item">
          ...
          <span class="qs-servicio-text">Inglés diario desde primero de preescolar hasta sexto de primaria</span>
        </div>
        <div class="qs-servicio-item">
        ...
        <div class="qs-servicio-item">
          ...
          <span class="qs-servicio-text">Circuito cerrado en todo nuestro plantel.</span>
        </div>
        <div class="qs-servicio-item">
          <img src="assets/img/romboamarillo.png" alt="Actividades al aire libre" class="qs-servicio-icon">
