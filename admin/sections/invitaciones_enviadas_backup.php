...
$registros_por_pagina = 10; // Puedes cambiar esto a 25, 50, etc.
$pagina_actual = isset($_GET['pagina']) ? max(1, intval($_GET['pagina'])) : 1;
$offset = ($pagina_actual - 1) * $registros_por_pagina;📄 CONFIGURACIÓN DE PAGINACIÓN
$registros_por_pagina = 10; // Puedes cambiar esto a 25, 50, etc.// 🔒 Conexión a la base de datos
include('../db.php');
